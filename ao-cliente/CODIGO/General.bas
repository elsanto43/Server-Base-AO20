...
Public coloresFaccion(0 To 4) As RGB
...
Sub SwitchMap(ByVal Map As Integer)
    ...
    Call mDx8_Luces.LightRemoveAll
        ...
        For X = XMinMapSize To XMaxMapSize
            ...
            With MapData(X, Y)
                ...
                If ByFlags And 64 Then
                    Call mDx8_Luces.Create_Light_To_Map(X, Y, fileBuff.getByte, fileBuff.getByte, fileBuff.getByte, fileBuff.getByte)
                End If
...
Sub Main()
    ...
    coloresFaccion(eNickColor.ieArmada).r = 0
    coloresFaccion(eNickColor.ieArmada).g = 100
    coloresFaccion(eNickColor.ieArmada).b = 211
    
    coloresFaccion(eNickColor.ieCiudadano).r = 0
    coloresFaccion(eNickColor.ieCiudadano).g = 128
    coloresFaccion(eNickColor.ieCiudadano).b = 255
    
    coloresFaccion(eNickColor.ieCriminal).r = 255
    coloresFaccion(eNickColor.ieCriminal).g = 0
    coloresFaccion(eNickColor.ieCriminal).b = 0
    
    coloresFaccion(eNickColor.ieNeutral).r = 188
    coloresFaccion(eNickColor.ieNeutral).g = 188
    coloresFaccion(eNickColor.ieNeutral).b = 188
    
    coloresFaccion(eNickColor.ieLegion).r = 200
    coloresFaccion(eNickColor.ieLegion).g = 0
    coloresFaccion(eNickColor.ieLegion).b = 0
