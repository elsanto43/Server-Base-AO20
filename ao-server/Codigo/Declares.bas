...
Public Type User
    ...
    Stats As UserStats
    flags As UserFlags
    targetMapBCK As WorldPos
    CasteoIndex As Byte
    CasteoSegundos As Byte
...
Public Destino() As tDestino
Public numDestinos As Byte
