        ...
        Case SendTarget.ToReal
            ...
            For LoopC = 1 To LastUser
                ...
                If (UserList(LoopC).ConnID <> -1) Then
                    ...
                    If UserList(LoopC).Faccion.Bando = eFaccion.Armada Then
                        Call UserList(LoopC).outgoingData.WriteASCIIStringFixed(sndData)
                    End If
        ...
        Case SendTarget.ToCaos
            ...
            For LoopC = 1 To LastUser
                ...
                If (UserList(LoopC).ConnID <> -1) Then
                    ...
                    If UserList(LoopC).Faccion.Bando = Legion Then
                        Call UserList(LoopC).outgoingData.WriteASCIIStringFixed(sndData)
                    End If
        ...
        Case SendTarget.ToRealYRMs
            ...
            For LoopC = 1 To LastUser
                ...
                If (UserList(LoopC).ConnID <> -1) Then
                    ...
                    If UserList(LoopC).Faccion.Bando = eFaccion.Armada Or (UserList(LoopC).flags.Privilegios And PlayerType.RoleMaster) <> 0 Then
                        Call UserList(LoopC).outgoingData.WriteASCIIStringFixed(sndData)
                    End If
        ...
        Case SendTarget.ToCaosYRMs
            ...
            For LoopC = 1 To LastUser
                ...
                If (UserList(LoopC).ConnID <> -1) Then
                    ...
                    If UserList(LoopC).Faccion.Bando = eFaccion.Legion Or (UserList(LoopC).flags.Privilegios And PlayerType.RoleMaster) <> 0 Then
                        Call UserList(LoopC).outgoingData.WriteASCIIStringFixed(sndData)
                    End If
