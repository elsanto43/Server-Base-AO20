...
Public Sub SalirDeParty(ByVal Userindex As Integer)
    ...
    '***************************************************
     ...
     If UserList(Userindex).Pos.map = Bestia_Map Then
        Call WriteConsoleMsg(Userindex, "No puedes salir de la party en este mapa.", FontTypeNames.FONTTYPE_INFO)
        Exit Sub
    End If
...
Public Sub ExpulsarDeParty(ByVal leader As Integer, ByVal OldMember As Integer)
    ...
    If UserList(leader).Pos.map = Bestia_Map Then
        Call WriteConsoleMsg(leader, "No puedes cerrar la party ni expulsar a nadie en este mapa.", FontTypeNames.FONTTYPE_INFO)
        Exit Sub
    End If
