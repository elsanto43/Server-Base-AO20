        ...
        With UserList(i)
            ...
            If .flags.UserLogged Then
                ...
                If .userTorneo.EnTorneo = True Then
                    userTorneo_PasaSegundo i
                End If
                
                If .CasteoSegundos > 0 Then
                    .CasteoSegundos = .CasteoSegundos - 1
                    If .CasteoSegundos = 0 Then
                        .flags.TargetMap = .targetMapBCK.map
                        .flags.TargetX = .targetMapBCK.x
                        .flags.TargetY = .targetMapBCK.y
                        .flags.Hechizo = .CasteoIndex
                        Call HandleHechizoTerreno(i, .CasteoIndex)
                    End If
                End If
                'Cerrar usuario
