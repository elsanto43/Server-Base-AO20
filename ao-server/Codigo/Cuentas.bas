...
Public Function UserEsNeutralCharfile(ByVal UserName As String) As Boolean
    '***************************************************
    'Author: Juan Andres Dalmasso (CHOTS)
    'Last Modification: 26/09/2018
    '***************************************************

    UserEsNeutralCharfile = CByte(GetVar(CharPath & UserName & ".chr", "Facciones", "Bando")) = eFaccion.Neutral

End Function

Public Function UserEsArmadaCharfile(ByVal UserName As String) As Boolean
    '***************************************************
    'Author: Juan Andres Dalmasso (CHOTS)
    'Last Modification: 26/09/2018
    '***************************************************

    UserEsArmadaCharfile = CByte(GetVar(CharPath & UserName & ".chr", "Facciones", "Bando")) = eFaccion.Armada

End Function

Public Function UserEsLegionCharfile(ByVal UserName As String) As Boolean
    '***************************************************
    'Author: Juan Andres Dalmasso (CHOTS)
    'Last Modification: 26/09/2018
    '***************************************************

    UserEsLegionCharfile = CByte(GetVar(CharPath & UserName & ".chr", "Facciones", "Bando")) = eFaccion.Legion
...
Public Function UserEsNeutral(ByVal UserName As String) As Boolean
    If Not Database_Enabled Then
        UserEsNeutral = UserEsNeutralCharfile(UserName)
    Else
        UserEsNeutral = UserEsNeutroDatabase(UserName)

    End If
End Function

Public Function UserEsArmada(ByVal UserName As String) As Boolean
    If Not Database_Enabled Then
        UserEsArmada = UserEsArmadaCharfile(UserName)
    Else
        UserEsArmada = UserEsArmadaDatabase(UserName)

    End If
End Function

Public Function UserEsLegion(ByVal UserName As String) As Boolean
    ...
    '***************************************************
    If Not Database_Enabled Then
        UserEsLegion = UserEsLegionCharfile(UserName)
    Else
        UserEsLegion = UserEsLegionDatabase(UserName)
