        ...
        For X = XMinMapSize To XMaxMapSize
            ...
            With MapData(X, Y)
                ...
                If .light_index Then
                    ...
                    Put FreeFileMap, , Light_List(.light_index).range
                    Put FreeFileMap, , CByte(Light_List(.light_index).RGBCOLOR.R)
                    Put FreeFileMap, , CByte(Light_List(.light_index).RGBCOLOR.G)
                    Put FreeFileMap, , CByte(Light_List(.light_index).RGBCOLOR.B)
        ...
        For X = XMinMapSize To XMaxMapSize
            ...
            With MapData(X, Y)
             ...
             '   If .light_index > 0 Then
              '      Delete_Light_To_Index .light_index
            '    End If
                ...
                If ByFlags And 64 Then
                    Get FreeFileMap, , tmpByte 'Rango de la luz
                    Get FreeFileMap, , tmpRgb(1) 'REd
                    Get FreeFileMap, , tmpRgb(2) 'blue
                    Get FreeFileMap, , tmpRgb(3) 'green
                    .light_index = mod_luces.Create_Light_To_Map(X, Y, tmpByte, tmpRgb(1), tmpRgb(2), tmpRgb(3))
                Else
                    .light_index = 0
                End If
